...
std::map<HWND, CWindowWnd*> g_mapWindowWnd;
//////////////////////////////////////////////////////////////////////////
///
...
LRESULT CALLBACK CWindowWnd::__WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    if( uMsg == WM_NCCREATE ) {
		...
		g_mapWindowWnd[hWnd] = pThis;
    } 
    else {
        //pThis = reinterpret_cast<CWindowWnd*>(::GetWindowLongPtr(hWnd, GWLP_USERDATA));
		map<HWND, CWindowWnd*>::iterator iter = g_mapWindowWnd.find(hWnd);
		if (iter != g_mapWindowWnd.end())
		{
			pThis = g_mapWindowWnd[hWnd];
		}
